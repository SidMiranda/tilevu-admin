    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="pages/apps/kanban-board.html">
          <i class="mdi mdi-tablet-dashboard menu-icon"></i>
      ...
      <li class="nav-item documentation-link">
        <a class="nav-link" href="http://www.bootstrapdash.com/demo/material-dash-bootstrap/documentation/documentation.html">
      ...
      <li class="nav-item">
        <div class="mdc-card premium-card">
          <div class="d-flex align-items-center">
            ...
            <div>
              <p class="mt-0 mb-1 ml-2 font-weight-bold text-small">SaaS service</p>
              <p class="mt-0 mb-0 ml-2 tx-10">Ad goes here</p>
            </div>
          </div>
          <p class="tx-8 mt-3 mb-3">lorem imsum dolor sit amet</p>
          <button class="btn btn-light w-100">Get Started</button>
        </div>
      </li>
    </ul>
  </nav>
